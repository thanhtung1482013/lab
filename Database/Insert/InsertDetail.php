...
<h2>Enter data into Detail table</h2>
<ul>
    <form name="InsertProductData" action="InsertDetail.php" method="POST" >
        ...
        <li>Sold Quantity:</li><li><input type="text" name="soldquantity" /></li>
...
$sql = "INSERT INTO detail(receiptid, productid, soldquantity)"
        . " VALUES('$_POST[receiptid]','$_POST[productid]','$_POST[soldquantity]')";
$stmt = $pdo->prepare($sql);
//$stmt->execute();
 if (is_null($_POST[receiptid])) {
   echo "Receipt ID must be not null";
 }
 elseif (is_null($_POST[productid])){
